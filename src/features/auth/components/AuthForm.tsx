...
import { FieldError, FieldErrorsImpl, FieldValues, UseFormHandleSubmit, UseFormRegister } from 'react-hook-form'
import { InputWithValidation } from '~/common/components'
  ...
  return (
    <form onSubmit={submit}>
      ...
      <button type='submit' className='btn mt-4 w-full bg-[#321898] py-2'>
        {type === 'SIGNUP' ? (loading ? 'registering ...' : 'Join now') : loading ? 'logging in ...' : 'Log In'}
      </button>
    </form>
  )
}
